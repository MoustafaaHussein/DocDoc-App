...
class RecomendationByEmoitionsModel extends Equatable {
  final int? id;
  final String? title;
  ...
  const RecomendationByEmoitionsModel({
    this.id,
    this.title,
    this.description,
    this.type,
  ...
  factory RecomendationByEmoitionsModel.fromJson(Map<String, dynamic> json) {
    return RecomendationByEmoitionsModel(
      id: json['id'] as int?,
