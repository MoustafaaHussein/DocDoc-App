...
class RecomendationByCategoryModel extends Equatable {
  final int? id;
  final String? title;
  ...
  const RecomendationByCategoryModel({
    this.id,
    this.title,
    this.description,
    this.type,
  ...
  factory RecomendationByCategoryModel.fromJson(Map<String, dynamic> json) =>
      RecomendationByCategoryModel(
        id: json['id'] as int?,
