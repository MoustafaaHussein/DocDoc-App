...
import 'package:docdoc_app/features/Home/presentation/views/widgets/advanced_paywall.dart';
            ...
            InkWell(
              onTap: () {
                ...
                if (state is PremiumActive) {
                  // User is premium → navigate to the premium screen
                  ...
                  showModalBottomSheet(
                    ...
                    builder: (_) => const AdvancedPaywall(),
                  );
                }
              },
              child: Container(
